...
WITH base AS (
    SELECT
        ...
        e.PAYMENT_TERMS,
        e.PO_NUMBER
    FROM FIN_ENT_AI_POC.CURATED_DOCS.INVOICE_PARSED p
    LEFT JOIN FIN_ENT_AI_POC.CURATED_DOCS.INVOICE_EXTRACT_AI e
...
FROM FIN_ENT_AI_POC.CURATED_DOCS.INVOICE_CHUNK
